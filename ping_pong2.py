...
# глобальная переменная отвечающая за расстояние
...
c = Canvas(root, width=WIDTH, height=HEIGHT, background="#90ee90")
c.pack()
...
# Привязка к Canvas этой функции
